    ...
    <div className="App">
      <header className="App-header">
        <img src={logo} className="App-logo" alt="logo" width="150" height="150" />
          <div>     
            <button onClick={handledSubtract} type="button" className="icon_button Minutes_button">
              <FaMinus />        
            </button>
          </div>
          ...
          <div>     
            <button onClick={handledAdd} type="button" className="icon_button Minutes_button">
              <FaPlus />        
            </button>
          </div>
        <p>
